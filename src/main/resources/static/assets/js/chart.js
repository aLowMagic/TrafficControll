...
$(document).ready(function() {
  ...
  /*======== 1. DUAL LINE CHART ========*/
  var dual = document.getElementById("dual-lines");
  if (dual !== null) {
  ...
  /*======== 3. LINE CHART NEW========*/
  var ctx = document.getElementById("linechart_new");
  if (ctx !== null) {
    var chart = new Chart(ctx, {
      // The type of chart we want to create
      type: "line",
  ...
  /*======== 6. AREA CHART ========*/
  var area = document.getElementById("area-charts");
  if (area !== null) {
  ...
  /*======== 11. DOUGHNUT CHART ========*/
  var doughnut = document.getElementById("doCharts");
  if (doughnut !== null) {
  ...
  /*======== 17. HORIZONTAL BAR CHART1 ========*/
  var hbar1 = document.getElementById("hbar123");
  if (hbar1 !== null) {
...
$(function(){
  $.extend({
    ...
    showChartCsv:function (dataset) {
      var barX = document.getElementById("barChartCsv");
      if (barX !== null) {
        var myChart = new Chart(barX, {
          type: "bar",
          data: {
